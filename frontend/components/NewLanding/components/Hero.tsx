  ...
  return (
    <section className="flex flex-col text-foreground transition-all duration-300">
      <div className="container max-w-7xl mx-auto flex flex-1 flex-col px-5 sm:px-10 z-50">
        ...
        <Image width={1920} height={1000} alt="hero-pc-dark" src="/Landing/colab-hero-bg.png" className="border-2 border-gray-200 dark:border-[#4d4d4d] rounded-2xl shadow-lg w-full flex mx-auto hidden dark:block" />
