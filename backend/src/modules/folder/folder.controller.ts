...
export const createFolder = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        sendResponse(res, true, result, "Folder created successfully", STATUS_CODES.CREATED);
    } catch (error: any) {
...
export const listFolders = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        sendResponse(res, true, result, "Folders fetched successfully", STATUS_CODES.OK);
    } catch (error: any) {
...
export const updateFolder = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        const result = await folderService.update(req.user!.id, parseInt(req.params.id as string), value);
        sendResponse(res, true, result, "Folder updated successfully", STATUS_CODES.OK);
    } catch (error: any) {
...
export const deleteFolder = async (req: Request, res: Response): Promise<void> => {
    try {
        const result = await folderService.softDelete(req.user!.id, parseInt(req.params.id as string));
        sendResponse(res, true, result, "Folder deleted successfully", STATUS_CODES.OK);
    } catch (error: any) {
