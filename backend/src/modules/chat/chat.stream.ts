...
export async function streamChat(req: Request, res: Response) {
    ...
    try {
        ...
        res.write(`data: ${JSON.stringify({ type: "message_id", userMessageId: userMessage.id })}\n\n`);
        ...
        try {
            ...
            console.error("  Error body:", JSON.stringify(aiError.error || aiError.response?.data, null, 2));
